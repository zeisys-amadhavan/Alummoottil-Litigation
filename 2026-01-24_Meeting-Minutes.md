...
3. Readable signature names are transcribed as text. <{signature}> separately records a visible signature or signature-like mark; it is metadata and is not part of the quoted text.
...
8. Source capitalization, punctuation, spelling, spacing, hyphenation, quotation marks, and grammatical errors are retained where legible; unclear or overwritten material is explicitly marked rather than guessed.
9. PDF-scan references are metadata cross-references to the 28-scan source PDF and are not document text.
10. Visible underlining and emphasis are recorded where explicitly tagged but are not exhaustively represented.
-->
...
<{Line 6}> The meeting Started at 11.am at the.
...
<{Line 7}> Dr. Sivedasan Channar expressed his willingness as a
...
<{Line 18}> All trustees agreed to this and appreciated Dr. Sivedasan
<{Line 19}> Channar for his dedication, generosity and affection
<{Line 20}> towards his Tharavad.
<{Line 21}> <{circled}> 2. Resolved that Dr. Sivedasan Channar is hereby granted
...
<{Line 30}> other trustees agree that Dr. Sivedasan Channar is
...
<{Line 24}> Alappuzha District, Muttom, PO, Pin 690511."
...
<{Line 5}> 1. Ramesh Chandran M <{signature}>
...
<{Line 1}> Alummoottil Tharavad Trust meeting on 22/XII/2023
...
<{Line 15}> Sivedasan Channar appreciated the
...
<{Line 22}> Sivedasan Channar reviewed the
...
<{Line 3}> Sivedasan Channar initiated the
...
<{Line 18}> 4. Sivedasan Channar
<{Line 19}> alias M. Sivedasan
<{Line 20}> 5. C.K. GITA. alias Gita Ravindran"
<{Line 21}> "Resolved that trustees can nominate only one
<{Line 22}> of his descendants/legal heirs as beneficiary."
...
<{Line 7}> (Law of Succession Succession). <{overwritten; repeated “Succession” partly unclear}>
...
<{Line 22}> Dec. 2023 at 3pm after the official function
<{Line 23}> are over. Sivedasan Channar also informed
...
<{Line 30}> <{circled}> 2. Sivedasan A. Madhavan <{signature}>
...
<{PDF scan 12; back sheet; no independent front-side document text; reverse-side show-through/bleed-through visible, including faint circled numerals}>

-PAGE 11-

<{PDF scan 13; handwritten book page 11}>

<{Line 1}> Alummoottil Tharavad Trust metg held on
...
<{Line 16}> Sivedasan Channar is facing fund
...
<{Line 1}> Alummoottil Tharavad Trust meeting held
<{Line 2}> on 06/02/2024 (Six february Two thousand & twenty four)
...
<{Line 7}> 5. C.K GITA <{unclear terminal punctuation}> <{signature}>
...
<{Line 2}> <{circled}> (i) CHINGOLI AYURVEDA HOSPITAL AND REASERCH
<{Line 3}> CENTRE
...
<{Line 5}> <{circled}> (f) A business Colaboration agreement for 5%
...
<{Line 17}> business Colaborations and MOA with
...
<{Line 31}> to Mr. Sivedasan Channar and Management
...
<{Line 2}> Mr. Sivedasan Channar had agreed to
...
<{Line 19}> back his amount. (after consulting C Accountant)
...
<{Line 32}> furniture item and utensils after restoration
...
<{Line 7}> kept as records. The balance item
